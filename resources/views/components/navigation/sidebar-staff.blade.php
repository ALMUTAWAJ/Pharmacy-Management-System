        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="#"
                    ...
                    <span
                        class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-purple-800 bg-purple-100 rounded-full dark:bg-purple-700 dark:text-purple-300">Pro</span>
                </a>
            </li>
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Customer Requests</span>
                </a>
            </li>
            <li>

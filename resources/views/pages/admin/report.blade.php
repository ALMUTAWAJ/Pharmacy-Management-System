...
<div class="grid grid-cols-2 gap-4 my-2">
    <div class="bg-white border border-gray-300 rounded-lg p-2">
        ...
        <div>
            <p class="text-md text-indigo-500 font-bold text-center">DB {{$totalRevenue}}</p>
        </div>
        <div>
      ...
      <!--Height rating -->
       <div class="col-span-2 md:grid-cols-5 border border-gray-300 bg-white rounded-lg p-2 shadow-sm">
              ...
              <div class="grid grid-cols-3">
                  <label for="number" class="col-span-2 mb-2 text-sm font-medium text-gray-600 dark:text-white">Top 3 Heighest rating products</label>

...
@section('admin-content')
    <section class="bg-white ">
        ...
        <div class="grid grid-cols-4 gap-4">
            ...
            <div class="col-span-1 ">
                ...
                <div id="dropdown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        ...
                        <li>
                            <a href="#"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Payments
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            {{-- <div class="py-8 flex items-center px-4 mx-auto max-w-2xl lg:py-16 border border-red-600 rounded-md"> --}}
        </div>
            ...
            <x-table>
                <tr>
                    <x-slot name="header">
                        ...
                        <x-table-col>more1</x-table-col>
                        <x-table-col>more2</x-table-col>
                        <x-table-col>more3</x-table-col>
                    </x-slot>
                </tr>
                <br>
                ...
                @for ($i = 0; $i < 30; $i++)
                    <tr class="border">
                        <x-table-col>{{ $i }}</x-table-col>
                        <x-table-col> Zeena</x-table-col>
                        <x-table-col>34</x-table-col>
                        <x-table-col>12-12</x-table-col>
                        <x-table-col>Actions</x-table-col>
                        <x-table-col>zeee</x-table-col>
                        <x-table-col>zeee</x-table-col>
                        <x-table-col>zeee</x-table-col>
                    </tr>
                @endfor
